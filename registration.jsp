  ...
  <div class="header">	
	...
	<div class="main">	
	   <div class="portfolio-top">
		   	<div class="wrap">
                            <h2>Registration <i class="glyphicon glyphicon-file "  style="color: #0681B2;"></i></h2>
			</div>
               <div>
               ...
               <div class="sign-up">
                   <form method="post" action="RegisterServlet">
                     <div class="sign-u">
						...
						<div class="sign-up2">
								<input type="text" class="text" name="fname" value="Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}">
						</div>
                    ...
                    <div class="sign-u">
						...
						<div class="sign-up2">
								<input type="text" class="text" name="lname" value="Last Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}">
						</div>
						<div class="clearfix"> </div>
					</div>
                    <div class="sign-u">
						...
						<div class="sign-up2">
								 <input type="email" class="text" name="email" value="Email Address" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email Address';}">
						</div>
						<div class="clearfix"> </div>
					</div>
					 <h3 class="tittle_reg">Login Information <i class="glyphicon glyphicon-off"></i></h3>
					<div class="sign-u">
				        <div class="sign-up1">
					...
					<div class="sign-u">
						...
						<div class="sign-up2">
								<input type="password" class="Password" name="cpassword" value="Confirm Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Confirm Password';}">
						</div>
						<div class="clearfix"> </div>
					</div>
                            <div>
                                <input type="submit" value="Register" class="lgnbtn btn-8 btn-8b">
                            </div>
                    </form>
		</div>
        </div>
